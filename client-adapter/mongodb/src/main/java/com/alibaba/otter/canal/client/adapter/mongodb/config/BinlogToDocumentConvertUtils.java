...
/**
 * <p>
 * Title: MongodbConvertUtil
 * </p>
 * <p>
 * Description: binlog 解析器  Document
 * </p>
 * <p>
 *
 */
public class BinlogToDocumentConvertUtils {
	
    protected final static Logger logger = LoggerFactory.getLogger(BinlogToDocumentConvertUtils.class);
     ...
     * @return
     */
    public static Document binlogToDocument(List<CanalEntry.Column> columns) {
